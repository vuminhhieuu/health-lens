...
user_name: ie303
date: '2026-03-28'
platformFocus: 'Web-First (MVP Phase 1)'
mobilePhase: 'Phase 2 — Epic 9 (FR11, FR27, FR28)'
---
...
**🚀 PLATFORM FOCUS UPDATE (Phase 1):** All MVP stories prioritized for Web platform. Mobile development begins in Phase 2 after Web MVP completion.
...
**CI/CD**
- GitHub Actions với workflows: test, build, deploy (tùy môi trường)
- Container Registry (GHCR hoặc tương đương) cho Docker images
...
FR11: Epic 9 (Phase 2) - Chụp ảnh bằng camera mobile
...
FR27: Epic 9 (Phase 2) - Mobile offline read-only lịch sử
FR28: Epic 9 (Phase 2) - Tự động đồng bộ khi có mạng
...
Người dùng có thể upload kết quả khám (PDF/ảnh từ thư viện trên web), xem dữ liệu OCR, sửa lỗi nhanh và lưu kết quả chính xác vào đúng hồ sơ. Chụp camera trên mobile thuộc Epic 9 (Phase 2).
...
Người dùng có thể theo dõi timeline khám bệnh, xem lại chi tiết và xóa bản ghi trên web. Offline và tự đồng bộ trên mobile thuộc Epic 9 (Phase 2).
...
Người dùng mobile có thể chụp ảnh trực tiếp, xem lịch sử đã cache khi offline và tự động đồng bộ khi có mạng.
**FRs covered:** FR11, FR27, FR28.
**Phụ thuộc:** Hoàn thành Epic 1–5 (API và dữ liệu cốt lõi).
...
## Epic 3: Thu Thập Kết Quả Khám và Khôi Phục OCR
Goal: Hoàn thiện end-to-end upload + OCR + manual recovery trên web (PDF/ảnh từ thư viện), tránh dead-end khi OCR không chính xác.

**Nền tảng (Phase 1):** Web — **Số story:** 5
...
**Nền tảng (Phase 1):** Web — **Số story:** 3
...
**Nền tảng:** Mobile (Expo) — **Số story:** 3  
**FRs covered:** FR11, FR27, FR28.  
**Phụ thuộc:** Epic 1–5 đã hoàn thành (API upload/OCR/lịch sử ổn định).
...
_(Trước đây: Story 3.2 — file story: `9-1-mobile-camera-capture-ux.md`)_
...
_(Trước đây: Story 5.4 — file story: `9-2-mobile-offline-readonly-history.md`)_
