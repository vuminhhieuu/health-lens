...
| 7.2 Audit log display (stub) | **Resolved** | — | **2026-05-21:** Full viewer tại `/admin/audit-log` (epic-7 `7-5-reference-data-audit-log-view` + remaining **6.4** / core **7-5** decomposition). Không còn placeholder. | Epic 7.5 + remaining-6-4 | `apps/web/src/app/admin/audit-log/page.tsx`, `components/admin/audit-log/`, `_bmad-output/implementation-artifacts/epic-7/7-5-reference-data-audit-log-view.md`, `_bmad-output/implementation-artifacts/remaining-production-review/.../6-4-*.md` |
