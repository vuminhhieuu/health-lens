...
class AuthControllerTest {
    ...
    void register_success() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/register")
                        ...
                        .content(toRegisterJson("Nguyen Van A", "user@example.com", "1999-01-01", "StrongPass1")))
    ...
    void register_duplicateEmail() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(toRegisterJson("Nguyen Van A", "existing@example.com", "1999-01-01", "StrongPass1")))
    ...
    void login_accountLocked() throws Exception {
        when(authService.login(any(LoginRequest.class)))
                .thenThrow(new AccountLockedException("Tai khoan bi khoa tam thoi. Thu lai sau 900 giay."));
    ...
    private String toRegisterJson(String fullName, String email, String birthDate, String password) {
        return "{\"fullName\":\"" + fullName + "\",\"email\":\"" + email + "\",\"birthDate\":\"" + birthDate + "\",\"password\":\"" + password + "\"}";
    }
}
