...
public final class ApiRoutes {
    ...
    public static final String USERS_ME_HEALTH_CONTEXT = USERS_ME + "/health-context";
    public static final String USERS_ME_HEALTH_CONTEXT_REL = USERS_ME_REL + "/health-context";
