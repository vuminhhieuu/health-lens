...
} from "@/components/marketing/PublicContentLayout";
    ...
    >
      <PublicContentSection id="bat-dau" title="1. Bắt đầu nhanh">
        <ol className="mt-4 list-decimal space-y-3 pl-5">
          <li>
            Tạo tài khoản bằng email và hoàn tất xác minh nếu được yêu cầu.
          </li>
          <li>
            Đọc và chấp nhận các điều khoản và quy định về dữ liệu sức khỏe
            trong ứng dụng.
          </li>
          <li>
            Tải lên kết quả khám dưới dạng PDF hoặc ảnh rõ nét, đối chiếu với
            phiếu gốc khi hệ thống nhắc.
          </li>
        </ol>
        <Link
          href="/register"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-[#bcc9c6]/30 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-[#4e6360]">
              Xem cách chúng tôi mô tả dữ liệu được xử lý trong quy định bảo
              mật.
            </p>
            <Link
              href="/privacy"
          ...
          <div className="rounded-xl border border-[#bcc9c6]/30 bg-white p-5">
            ...
            <h3 className="mt-3 font-bold text-[#121e1c]">
              Câu hỏi thường gặp
            </h3>
            <p className="mt-2 text-sm leading-6 text-[#4e6360]">
              Các câu hỏi chung về tài khoản và dịch vụ được tóm tắt tại trang
              thắc mắc.
            </p>
            <Link
              href="/questions"
      ...
      <PublicContentSection id="luu-y" title="3. Lưu ý y tế">
        <p>
          HealthLens giúp bạn theo dõi và đọc lại kết quả dễ hơn, nhưng không
          thay thế tư vấn y tế chuyên môn. Khi có triệu chứng bất thường hoặc
          cần quyết định điều trị, hãy liên hệ bác sĩ hoặc cơ sở y tế.
        </p>
      </PublicContentSection>
    </PublicContentLayout>
  );
