...
**Quyết Định:** GitLab CI
**Lý Do:** Tích hợp với GitLab (nơi host source code), Container Registry tích hợp sẵn
...
- GitLab CI/CD Variables cho secrets
...
1. **Thiết Lập Dự Án** — Monorepo, Docker Compose, GitLab CI skeleton
...
| `.gitlab-ci.yml` | Pipeline CI/CD | Không |
...
**Vấn Đề #1: GitLab CI vs GitHub Actions**
- **Đã Giải Quyết:** Đã chuyển từ GitHub Actions sang GitLab CI theo preference người dùng
- **Tác Động:** `.gitlab-ci.yml` thay thế `.github/workflows/`
...
**Thứ Tự Triển Khai:**
1. Thiết Lập Dự Án (monorepo, Docker Compose, skeleton GitLab CI)
